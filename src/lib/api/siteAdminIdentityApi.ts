...
export function getSiteIdentitySecurityOverview(token: string) {
  return openApiRequest("/api/v1/site-admin/identity-security/overview", "get", {
    token,
    cache: "no-store",
    pathParams: {},
  });
...
export function listSiteLoginHistory(
  ...
  return openApiRequest("/api/v1/site-admin/identity-security/login-history", "get", {
    token,
    cache: "no-store",
    pathParams: {},
...
export function listSiteTrustedDevices(
  ...
  return openApiRequest("/api/v1/site-admin/identity-security/trusted-devices", "get", {
    token,
    cache: "no-store",
    pathParams: {},
...
export function revokeSiteTrustedDevice(token: string, deviceId: string, payload: { reason?: string } = {}) {
  return openApiRequest("/api/v1/site-admin/identity-security/trusted-devices/{deviceId}/revoke", "patch", {
    token,
    pathParams: { deviceId },
...
export function listSiteSsoProviders(
  ...
  return openApiRequest("/api/v1/site-admin/identity-security/sso-providers", "get", {
    token,
    cache: "no-store",
    pathParams: {},
...
export function listSiteSecurityPolicies(
  ...
  return openApiRequest("/api/v1/site-admin/identity-security/policies", "get", {
    token,
    cache: "no-store",
    pathParams: {},
...
export function sendSiteAdminPasswordReset(token: string, userId: string) {
  return openApiRequest("/api/v1/site-admin/identity-security/users/{userId}/password-reset", "post", {
    token,
    pathParams: { userId },
  });
}
...
export function listSiteSessions(
  ...
  return openApiRequest("/api/v1/site-admin/sessions", "get", {
    token,
    cache: "no-store",
    pathParams: {},
...
export function revokeSiteSession(token: string, sessionId: string, payload: { reason?: string } = {}) {
  return openApiRequest("/api/v1/site-admin/sessions/{sessionId}/revoke", "patch", {
    token,
